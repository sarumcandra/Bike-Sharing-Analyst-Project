...
# data
day_df = pd.read_csv('sarumcandra/bike-sharing-analyst-project/main/dashboard/day.csv')
hour_df = pd.read_csv('sarumcandra/bike-sharing-analyst-project/main/dashboard/hour.csv')
